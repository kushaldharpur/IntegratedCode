...
export class TransferAdminService {
    ...
    getAllAdmins(token): Observable<Data[]> {
        ...
        return this.http.get("http://172.17.120.71:9890/lims/getAllAdminDetails",options)
    ...
    newAdmin(AdminId:string,token){
        ...
        return this.http.get("http://172.17.120.71:9890/lims/transferAccess/"+this.mid+"/"+AdminId,options)
    }
}
